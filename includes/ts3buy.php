...
<div class="col-md-5 Featimg"> <img src="images/ts3.jpg" width="314" height="314" alt="feature" class="img-responsive center-block"></div>
<div class="col-md-7">
<h1>Team Speak 3</h1>
<p class="lead">Buy & Pay</p>
<p>As soon as you make a successful payment via PayPal or Google Checkout, your TS3 will be activated immediately. No waiting time whatsoever. Our network runs the latest stable and secure versions of TS3 engine!</p>
<ul class="ticklist">
...
<div id="odaberi_igru_box">
	...
	<form class="col-md-6 col-md-offset-3" action=""  method="post">
		...
		<select type="text"  class="form-control " name="igra" >
			<option value="cs">Team Speak 3</option>
	...
	<div class="form-group">
     ...
     <div class="form-group">	
		<select type="text" name="igra"  required="required" class="form-control" placeholder="Service">
			<option value="Team Speak 3">Team Speak 3 </option>
		</select> 
	 </div>
     <div class="form-group">		
		<select type="text" name="drzava"  required="required" class="form-control" placeholder="Country">
			<option value="Server Querry">Server Querry</option>
		</select>
	</div>
     <div class="form-group">			
     ...
     <div class="form-group">	
		<select type="text" name="slot"  required="required" class="form-control" placeholder="Packet">
			...
			<option value="200 slot 7€">250 Slot - €7/mo</option>
			<option value="200 slot 8€">300 Slot - €8/mo</option>
			<option value="200 slot 9€">400 Slot - €9/mo</option>
			<option value="500 slot 10€">500 Slot - €10/mo</option>
		</select> 			
		<br />
